function [group] = SPartition(metamodel,threshold,k,Imbalance_ratio)
...
dos([hmetis_path 'shmetis.exe ' hmetis_path 'temp.hgr ' int2str(number_of_partitions) ' ' num2str(Imbalance_ratio)]);
